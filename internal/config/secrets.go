...
var secretMapping = map[string]string{
	...
	"server-s3-bucket":             "OPENSANDBOX_S3_BUCKET",
	"server-s3-region":             "OPENSANDBOX_S3_REGION",
	"server-s3-endpoint":           "OPENSANDBOX_S3_ENDPOINT",
	"server-s3-force-path-style":   "OPENSANDBOX_S3_FORCE_PATH_STYLE",
	...
	// Server-side cell config + shared secrets.
