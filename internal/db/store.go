...
func (s *Store) Migrate(ctx context.Context) error {
	...
	migrations := []struct {
		...
		{21, "migrations/021_org_max_disk_mb.up.sql"},
		{22, "migrations/022_scale_events_disk_mb.up.sql"},
		{23, "migrations/023_migration_state.up.sql"},
		{24, "migrations/024_orgs_price_locked.up.sql"},
		{25, "migrations/025_checkpoints_public.up.sql"},
		{26, "migrations/026_free_credits_remaining_cents.up.sql"},
		{27, "migrations/027_patch_error_tracking.up.sql"},
		{28, "migrations/028_sandbox_golden_version.up.sql"},
		{29, "migrations/029_sandbox_tags.up.sql"},
		{30, "migrations/030_capacity_reservation_intervals.up.sql"},
		{31, "migrations/031_capacity_idempotency_keys.up.sql"},
		{32, "migrations/032_orgs_max_memory_gb.up.sql"},
		{33, "migrations/033_billable_events.up.sql"},
		{34, "migrations/034_orgs_billing_mode.up.sql"},
