/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 25b8bef949716b18f45a0af63abcbfea)
// Runtime types generated with workerd@1.20260730.1 2026-08-02 nodejs_compat
interface __BaseEnv_Env {
	POC_VM_ID: string;
	DO_LOCATION_HINT?: string;
	VM_SESSIONS: DurableObjectNamespace<import("./src/index").VmSession>;
	VM_ROSTER: DurableObjectNamespace<import("./src/index").VmRoster>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "VmSession";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "POC_VM_ID">> {}
}
