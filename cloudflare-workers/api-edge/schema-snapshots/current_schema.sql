...
, is_halted INTEGER NOT NULL DEFAULT 0, halted_at INTEGER, custom_domain TEXT, cf_hostname_id TEXT, domain_verification_status TEXT NOT NULL DEFAULT 'none', domain_ssl_status TEXT NOT NULL DEFAULT 'none', verification_txt_name TEXT, verification_txt_value TEXT, ssl_txt_name TEXT, ssl_txt_value TEXT, free_credits_remaining_cents INTEGER NOT NULL DEFAULT 500, credit_balance_cents INTEGER NOT NULL DEFAULT 0, max_concurrent_sandboxes INTEGER NOT NULL DEFAULT 5, max_sandbox_timeout_sec INTEGER NOT NULL DEFAULT 3600, max_disk_mb INTEGER NOT NULL DEFAULT 0, max_memory_gb INTEGER NOT NULL DEFAULT 0, billing_mode TEXT NOT NULL DEFAULT 'unified', last_usage_reported_at INTEGER NOT NULL DEFAULT 0, billing_provider TEXT NOT NULL DEFAULT 'legacy', autumn_usage_watermark INTEGER NOT NULL DEFAULT 0, has_webhooks INTEGER NOT NULL DEFAULT 0, model_billing_status TEXT NOT NULL DEFAULT 'off', model_markup_bps INTEGER NOT NULL DEFAULT 0, autumn_concurrency_override INTEGER);
