...
func main() {
	...
	if cfg.Mode == "server" && redisRegistry != nil {
		...
		spec := compute.WorkerSpec{
			...
			RootDiskBackend:         cfg.RootDiskBackend,
			CloudDiskCLIPath:        cfg.CloudDiskCLIPath,
			CloudDiskCachePath:      cfg.CloudDiskCachePath,
			CloudDiskDefaultSizeMB:  cfg.CloudDiskDefaultSizeMB,
			CloudDiskGoldenDisk:     cfg.CloudDiskGoldenDisk,
			CloudDiskGoldenSnapshot: cfg.CloudDiskGoldenSnapshot,
			CloudDiskS3Endpoint:     cfg.CloudDiskS3Endpoint,
			CloudDiskS3Region:       cfg.CloudDiskS3Region,
			CloudDiskS3AccessKeyID:  cfg.CloudDiskS3AccessKeyID,
			CloudDiskS3SecretKey:    cfg.CloudDiskS3SecretKey,
