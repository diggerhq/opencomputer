...
Every MicroVM sandbox has a hard end time. When it arrives, the provider destroys the host and
...
[Hibernate and wake](/microvm/hibernate).
...
[Idle timeout](/microvm/idle-timeout).
