...
All data is lost unless you've created a [checkpoint](/v2/cli/checkpoint) first.
...
<Tip>
  SDK usage: [Sandboxes](/v2/sandboxes/overview). Full flags: [CLI Reference](/reference/cli#oc-sandbox).
</Tip>
