...
| Interactive development, debugging | [`oc shell`](/v2/cli/shell) |

<Tip>
  SDK usage: [Running Commands](/v2/sandboxes/running-commands). Full flags: [CLI Reference](/reference/cli#oc-exec).
</Tip>
