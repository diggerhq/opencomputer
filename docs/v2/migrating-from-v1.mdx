...
Nothing changes for you until your org is moved to v2. The [v1 docs](/introduction) stay
accurate until then — switch versions with the selector at the top of the page.
...
<Steps>
  <Step title="Does any sandbox need to live longer than 8 hours?">
    ...
    [Sandbox lifetime](/v2/sandboxes/lifetime).
  </Step>
...
that sandbox. See [Secrets](/v2/sandboxes/secrets).
