...
Run a command synchronously. [HTTP API →](/v2/api-reference/exec/run)
...
Start a long-running command with streaming. [HTTP API →](/v2/api-reference/exec/create-session)
...
List all exec sessions. [HTTP API →](/v2/api-reference/exec/list-sessions)
...
Kill an exec session. Default signal: `9` (SIGKILL). [HTTP API →](/v2/api-reference/exec/kill-session)
