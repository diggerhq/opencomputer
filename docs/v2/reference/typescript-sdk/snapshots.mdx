...
Create a pre-built snapshot from a declarative image. [HTTP API →](/v2/api-reference/snapshots/create)
...
List all snapshots. [HTTP API →](/v2/api-reference/snapshots/list)
...
Get a snapshot by name. [HTTP API →](/v2/api-reference/snapshots/get)
...
Delete a snapshot. Existing sandboxes created from it are not affected. [HTTP API →](/v2/api-reference/snapshots/delete)
