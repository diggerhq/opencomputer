...
<ParamField body="image" type="Image">
  Declarative image definition (see [Image](/v2/reference/python-sdk/image))
</ParamField>
...
[HTTP API →](/v2/api-reference/patches/create)
...
[HTTP API →](/v2/api-reference/patches/list) — **Returns:** `list[dict]`

### `await Sandbox.delete_checkpoint_patch(checkpoint_id, patch_id, ...)`

[HTTP API →](/v2/api-reference/patches/delete) — **Returns:** `None`
...
Update idle timeout. [HTTP API →](/v2/api-reference/sandboxes/set-timeout)
...
[HTTP API →](/v2/api-reference/checkpoints/list) — **Returns:** `list[dict]`
...
[HTTP API →](/v2/api-reference/checkpoints/delete) — **Returns:** `None`
...
[HTTP API →](/v2/api-reference/preview/list) — **Returns:** `list[dict]`

### `await sandbox.delete_preview_url(port)`

[HTTP API →](/v2/api-reference/preview/delete) — **Returns:** `None`
...
These features are TypeScript-only. Use the [HTTP API](/v2/api-reference/overview) directly:
...
<ParamField body="exec" type="Exec">
  [Command execution](/v2/reference/python-sdk/exec)
</ParamField>

<ParamField body="files" type="Filesystem">
  [File operations](/v2/reference/python-sdk/filesystem)
</ParamField>

<ParamField body="pty" type="Pty">
  [Terminal sessions](/v2/reference/python-sdk/pty)
</ParamField>
