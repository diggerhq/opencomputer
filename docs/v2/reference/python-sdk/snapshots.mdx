...
Create a pre-built snapshot. [HTTP API →](/v2/api-reference/snapshots/create)
...
[HTTP API →](/v2/api-reference/snapshots/list) — **Returns:** `list[dict]`

## `await snapshots.get(name)`

[HTTP API →](/v2/api-reference/snapshots/get)
...
Delete a snapshot. Existing sandboxes are not affected. [HTTP API →](/v2/api-reference/snapshots/delete)
