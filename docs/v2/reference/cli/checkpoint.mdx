...
Create a named checkpoint of a running sandbox. [HTTP API →](/v2/api-reference/checkpoints/create)
...
List checkpoints for a sandbox. [HTTP API →](/v2/api-reference/checkpoints/list)
...
Revert a sandbox in-place to a checkpoint. All changes since the checkpoint are lost. [HTTP API →](/v2/api-reference/checkpoints/restore)

---

## `oc checkpoint spawn <checkpoint-id>`

Create a new sandbox from a checkpoint (fork). [HTTP API →](/v2/api-reference/checkpoints/fork)
...
Delete a checkpoint. [HTTP API →](/v2/api-reference/checkpoints/delete)
