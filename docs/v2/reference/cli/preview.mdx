...
[HTTP API →](/v2/api-reference/preview/list)
...
[HTTP API →](/v2/api-reference/preview/delete)

---

## `oc preview rotate-auth <sandbox-id>`

[HTTP API →](/v2/api-reference/preview/rotate-auth)
...
See [`oc sandbox create --preview-auth`](/v2/reference/cli/sandbox#oc-sandbox-create) to enable at create time, or [`--preview-auth-token`](/v2/reference/cli/sandbox#oc-sandbox-create) to bring your own.
