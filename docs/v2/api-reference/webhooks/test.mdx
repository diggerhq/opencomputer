...
[deliveries](/v2/api-reference/webhooks/deliveries-list) for the outcome.
...
See [Webhooks](/v2/sandboxes/webhooks).
...
`messageId` is the delivery's message id — find its attempt under [deliveries](/v2/api-reference/webhooks/deliveries-list).
