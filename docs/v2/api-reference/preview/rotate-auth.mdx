...
If the sandbox was originally created without [`previewAuth`](/v2/api-reference/sandboxes/create), this call installs a token and starts enforcing the gate from that point on.
