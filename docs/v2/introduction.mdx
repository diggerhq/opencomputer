...
<CardGroup cols={2}>
  ...
  <Card title="How It Works" icon="microchip" href="/v2/how-it-works">
    Architecture: VMs, hibernation, checkpoints
  </Card>
  <Card title="Sandboxes" icon="box" href="/v2/sandboxes/overview">
    The compute primitive
  </Card>
  <Card title="Working with Files" icon="file" href="/v2/sandboxes/working-with-files">
