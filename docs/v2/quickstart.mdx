...
An OpenComputer API key and the SDK installed. See [Introduction](/v2/introduction) for install instructions.
...
<CardGroup cols={2}>
  <Card title="Elastic Compute" icon="gauge-high" href="/v2/sandboxes/elasticity">
    Scale memory and CPU at runtime based on workload
  </Card>
  <Card title="Upload & Download Files" icon="file-arrow-up" href="/v2/sandboxes/working-with-files">
    Read, write, and transfer files to and from sandboxes
  </Card>
  <Card title="Custom Sandboxes" icon="palette" href="/v2/sandboxes/templates">
    Build custom environments with your own packages and tools
  </Card>
  <Card title="Checkpoints" icon="code-branch" href="/v2/sandboxes/checkpoints">
