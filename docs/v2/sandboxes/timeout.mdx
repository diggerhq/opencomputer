...
- [Lifecycle overview](/v2/sandboxes/overview#lifecycle) — all sandbox states
- [Set timeout API](/v2/api-reference/sandboxes/set-timeout)
- [Hibernate API](/v2/api-reference/sandboxes/hibernate) / [Wake API](/v2/api-reference/sandboxes/wake)
