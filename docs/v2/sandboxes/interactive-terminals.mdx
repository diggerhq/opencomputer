...
Terminal size is auto-detected and resize events are forwarded. See [`oc shell`](/v2/cli/shell) for details.

<Tip>
  CLI equivalent: [`oc shell`](/v2/cli/shell). Full reference: [TypeScript SDK](/reference/typescript-sdk#pty) · [Python SDK](/reference/python-sdk#pty) · [HTTP API](/reference/api#pty).
</Tip>
