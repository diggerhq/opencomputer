...
[`GET /api/sandboxes/:id/usage`](/v2/api-reference/usage/get-sandbox-usage)
...
[`GET /api/usage`](/v2/api-reference/usage/get-usage) instead.
...
[API page](/v2/api-reference/usage/get-sandbox-usage).
...
[API reference](/v2/api-reference/usage/get-sandbox-usage).
...
Full TypeScript SDK reference: [Usage & Tags](/v2/reference/typescript-sdk/usage).
