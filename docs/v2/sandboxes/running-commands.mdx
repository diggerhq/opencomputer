...
<Tip>
  CLI equivalent: [`oc exec`](/v2/cli/exec). Full reference: [TypeScript SDK](/reference/typescript-sdk#exec) · [Python SDK](/reference/python-sdk#exec) · [HTTP API](/reference/api#commands-exec).
</Tip>
