...
<ParamField query="from" type="string">
  Inclusive lower bound. Accepts either a date (`2026-05-27`, treated
  as UTC midnight) or a full RFC3339 timestamp. Default: now minus
  30 days. Max window: 90 days.
</ParamField>

<ParamField query="to" type="string">
  Exclusive upper bound. Same format as `from`. Default: now.
</ParamField>
