...
export OPENSANDBOX_API_URL="https://api.opensandbox.dev"  # optional, defaults to localhost
```
...
Or pass credentials directly when creating a sandbox — see [Configuration](/configuration).
...
- [Configuration](/configuration) — API keys, URLs, and environment setup
