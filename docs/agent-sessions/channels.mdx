...
mode: "wide"
title: "Channels"
description: "Talk to a session where people already work — Slack, GitHub"
---

<Note>**Labs preview.** Channels are not part of the stable Durable Sessions API. The stable path is to converse with a session over the [API](/agent-sessions/messaging) and deliver events out via [webhooks](/agent-sessions/webhooks).</Note>
