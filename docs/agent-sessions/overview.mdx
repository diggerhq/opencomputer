...
<CardGroup cols={2}>
  <Card title="Self-healing runtime" icon="heart-pulse">
    ...
    - Turn deadlines bound hangs
  </Card>
  <Card title="Brain / hands sandboxing" icon="shield-halved">
    - The **brain** (agent loop) runs apart from the **hands** sandbox (files and commands)
    - Untrusted file and shell work stays contained
    - Your model key stays in the [secret store](/sandboxes/secrets), never in either sandbox
  </Card>
