...
The OpenComputer-owned App is the current simplest path and is installed from the dashboard or GitHub, not by minting an install URL through the SDK. Bring-your-own GitHub App support adds more App records later; repo and session shapes stay the same. **No credential passes through this API.**
