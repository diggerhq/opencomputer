...
1. You create a session from an [agent](/agent-sessions/agents) (and a [model credential](/agent-sessions/credentials) — both required). The session starts immediately.
