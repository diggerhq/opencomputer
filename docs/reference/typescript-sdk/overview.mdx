...
<CardGroup cols={2}>
  ...
  <Card title="Serverless Agents client" icon="robot" href="/reference/typescript-sdk/managed-agents">
    The management API client on the portable `@opencomputer/sdk/managed-agents` subpath
  </Card>
</CardGroup>
