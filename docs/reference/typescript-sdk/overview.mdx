...
<CardGroup cols={2}>
  ...
  <Card title="Serverless Agents client" icon="robot" href="/reference/typescript-sdk/agents">
    The management API client on the portable `@opencomputer/sdk/agents` subpath
  </Card>
</CardGroup>
