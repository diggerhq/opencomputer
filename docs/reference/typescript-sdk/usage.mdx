...
<ParamField body="to" type="string">
  RFC3339 upper bound. Default: now. Window must be at most 30 days.
</ParamField>
...
<ParamField body="from" type="string">
  RFC3339 lower bound. Default: now minus 30 days.
</ParamField>

<ParamField body="to" type="string">
  RFC3339 upper bound. Default: now. Window must be at most 90 days.
</ParamField>
