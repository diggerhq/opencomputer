...
```http
GET /api/sandboxes/sb-abc/usage?from=2026-05-27&to=2026-05-28
```

Path carries the sandbox ID. `from` and `to` accept either a date
(`2026-05-27`, interpreted as UTC midnight) or a full timestamp
(`2026-05-27T15:30:00Z`). Both are optional — omit for the last
hour. Max window is **30 days**. Full param reference: the
