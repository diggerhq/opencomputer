...
```mermaid
flowchart LR
    Trigger[Message, schedule,<br/>webhook, or event]
...
configuration—such as secrets, schedule state, and webhook tokens—separate.
Read
...
<CardGroup cols={2}>
  ...
  <Card title="Database" icon="database" href="/agents/database">
    Store application state and durable work for application-owned workers.
  </Card>
</CardGroup>
