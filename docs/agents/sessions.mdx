...
exports the file into retained storage, records its byte count and SHA-256, and
authorizes a short-lived direct download. The CLI streams that retained copy to
disk, verifying both fields before the file is saved.
