...
Files the agent leaves under `/workspace` persist with the session. To take
an exact, hashed copy of one out to your own storage, see
[Workspace artifact exports](/agents/artifacts).
