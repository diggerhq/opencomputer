...
A [render](/agents/mental-model#a-render-is-one-call-of-your-agent-function)
is one call of your agent function. One turn can carry several renders, one
per model step. The debug inspector in the [playground](/agents/playground)
shows the same data.
