...
For every hook and declaration helper, including input types, tool execution
context, MCP servers, skills, and session data, see the [Agent authoring API
reference](/agents/authoring-api).
