...
const (
	...
	SandboxAgent_ConfigureLogship_FullMethodName  = "/agent.SandboxAgent/ConfigureLogship"
...
//
// SandboxAgent is the in-guest RPC surface. It runs as PID 1 (or under
// systemd) inside every sandbox VM and is reachable from the host worker
// over virtio-serial (Unix domain socket) or vsock.
//
// === STABILITY CONTRACT ===
// This proto is a stable, backward-compatible public API. Long-running
// sandboxes can live for weeks or months; their in-guest agent continues
// running whatever version was baked into the rootfs at sandbox-creation
// time. The worker must be able to talk to those old agents indefinitely.
//
// Allowed changes:
//   - Adding new RPCs
//   - Adding new optional fields to existing messages (with new field numbers)
//   - Adding new enum values
//
// FORBIDDEN changes:
//   - Removing or renaming RPCs, messages, fields, or enum values
//   - Repurposing existing field numbers for different semantics
//   - Making previously-optional fields required
//   - Changing field types in a non-wire-compatible way
//
// New capabilities should prefer being implemented worker-side, composing
// Exec + file primitives, rather than adding a new agent RPC. An agent
// binary update requires the sandbox to be destroyed and recreated; there
// is intentionally no runtime upgrade path.
//
// See internal/qemu/manager.go "Runtime agent upgrade" comment for the
// full rationale on why we don't hot-upgrade.
type SandboxAgentClient interface {
	...
	// ConfigureLogship sets sandbox session log-shipping configuration.
	// Worker calls this immediately after VM boot, before any user-facing
	// operations. Empty ingest_token disables shipping (kill-switch).
	// If never called, the agent's forwarder stays dormant — log events
	// queue in a bounded ring and are dropped oldest-first.
	ConfigureLogship(ctx context.Context, in *ConfigureLogshipRequest, opts ...grpc.CallOption) (*ConfigureLogshipResponse, error)
	...
	// Thaw unfreezes guest filesystems via a native FITHAW ioctl (no exec). The
	// golden/hibernate snapshot is captured with the rootfs fsfrozen; this undoes
	// that on wake/fork/golden-restore. It is native precisely so it never depends
...
func (c *sandboxAgentClient) ConfigureLogship(ctx context.Context, in *ConfigureLogshipRequest, opts ...grpc.CallOption) (*ConfigureLogshipResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ConfigureLogshipResponse)
	err := c.cc.Invoke(ctx, SandboxAgent_ConfigureLogship_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sandboxAgentClient) Thaw(ctx context.Context, in *ThawRequest, opts ...grpc.CallOption) (*ThawResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ThawResponse)
	err := c.cc.Invoke(ctx, SandboxAgent_Thaw_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SandboxAgentServer interface {
	...
	// If never called, the agent's forwarder stays dormant — log events
	// queue in a bounded ring and are dropped oldest-first.
	ConfigureLogship(context.Context, *ConfigureLogshipRequest) (*ConfigureLogshipResponse, error)
	// Shutdown gracefully terminates the agent and syncs disks.
...
func (UnimplementedSandboxAgentServer) PTYCreate(context.Context, *PTYCreateRequest) (*PTYCreateResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PTYCreate not implemented")
}
func (UnimplementedSandboxAgentServer) PTYResize(context.Context, *PTYResizeRequest) (*PTYResizeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PTYResize not implemented")
}
func (UnimplementedSandboxAgentServer) PTYKill(context.Context, *PTYKillRequest) (*PTYKillResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PTYKill not implemented")
}
func (UnimplementedSandboxAgentServer) PTYAttach(grpc.BidiStreamingServer[PTYInput, PTYOutput]) error {
	return status.Errorf(codes.Unimplemented, "method PTYAttach not implemented")
}
func (UnimplementedSandboxAgentServer) ExecSessionCreate(context.Context, *ExecSessionCreateRequest) (*ExecSessionCreateResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ExecSessionCreate not implemented")
}
func (UnimplementedSandboxAgentServer) ExecSessionAttach(grpc.BidiStreamingServer[ExecSessionInput, ExecSessionOutput]) error {
	return status.Errorf(codes.Unimplemented, "method ExecSessionAttach not implemented")
}
func (UnimplementedSandboxAgentServer) ExecSessionList(context.Context, *ExecSessionListRequest) (*ExecSessionListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ExecSessionList not implemented")
}
func (UnimplementedSandboxAgentServer) ExecSessionKill(context.Context, *ExecSessionKillRequest) (*ExecSessionKillResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ExecSessionKill not implemented")
}
...
func (UnimplementedSandboxAgentServer) ConfigureLogship(context.Context, *ConfigureLogshipRequest) (*ConfigureLogshipResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ConfigureLogship not implemented")
}
...
func (UnimplementedSandboxAgentServer) SyncFS(context.Context, *SyncFSRequest) (*SyncFSResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SyncFS not implemented")
}
func (UnimplementedSandboxAgentServer) PrepareHibernate(context.Context, *PrepareHibernateRequest) (*PrepareHibernateResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PrepareHibernate not implemented")
}
...
func RegisterSandboxAgentServer(s grpc.ServiceRegistrar, srv SandboxAgentServer) {
	// If the following call pancis, it indicates UnimplementedSandboxAgentServer was
...
func _SandboxAgent_ConfigureLogship_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ConfigureLogshipRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SandboxAgentServer).ConfigureLogship(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SandboxAgent_ConfigureLogship_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SandboxAgentServer).ConfigureLogship(ctx, req.(*ConfigureLogshipRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _SandboxAgent_Thaw_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ThawRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SandboxAgentServer).Thaw(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SandboxAgent_Thaw_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SandboxAgentServer).Thaw(ctx, req.(*ThawRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SandboxAgent_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ConfigureLogship",
			Handler:    _SandboxAgent_ConfigureLogship_Handler,
		},
		{
			MethodName: "Shutdown",
