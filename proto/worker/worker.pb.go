...
type IsTAPAvailableRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	SandboxId     string                 `protobuf:"bytes,1,opt,name=sandbox_id,json=sandboxId,proto3" json:"sandbox_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *IsTAPAvailableRequest) Reset() {
	*x = IsTAPAvailableRequest{}
	mi := &file_proto_worker_worker_proto_msgTypes[27]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *IsTAPAvailableRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IsTAPAvailableRequest) ProtoMessage() {}

func (x *IsTAPAvailableRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_worker_worker_proto_msgTypes[27]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IsTAPAvailableRequest.ProtoReflect.Descriptor instead.
func (*IsTAPAvailableRequest) Descriptor() ([]byte, []int) {
	return file_proto_worker_worker_proto_rawDescGZIP(), []int{27}
}

func (x *IsTAPAvailableRequest) GetSandboxId() string {
	if x != nil {
		return x.SandboxId
	}
	return ""
...
type IsTAPAvailableResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *IsTAPAvailableResponse) Reset() {
	*x = IsTAPAvailableResponse{}
	mi := &file_proto_worker_worker_proto_msgTypes[28]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *IsTAPAvailableResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IsTAPAvailableResponse) ProtoMessage() {}

func (x *IsTAPAvailableResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_worker_worker_proto_msgTypes[28]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IsTAPAvailableResponse.ProtoReflect.Descriptor instead.
func (*IsTAPAvailableResponse) Descriptor() ([]byte, []int) {
	return file_proto_worker_worker_proto_rawDescGZIP(), []int{28}
}

func (x *IsTAPAvailableResponse) GetAvailable() bool {
	if x != nil {
		return x.Available
	}
	return false
...
const file_proto_worker_worker_proto_rawDesc = "" +
	...
	"sandbox_id\x18\x01 \x01(\tR\tsandboxId\x12\x16\n" +
	"\x06status\x18\x02 \x01(\tR\x06status\"6\n" +
	"\x15IsTAPAvailableRequest\x12\x1d\n" +
	"\n" +
	"sandbox_id\x18\x01 \x01(\tR\tsandboxId\"6\n" +
	"\x16IsTAPAvailableResponse\x12\x1c\n" +
	"\tavailable\x18\x01 \x01(\bR\tavailable\"W\n" +
	...
	"\x04pids\x18\x06 \x01(\x05R\x04pids2\xed\t\n" +
	"\rSandboxWorker\x12L\n" +
	...
	"\x0eIsTAPAvailable\x12\x1d.worker.IsTAPAvailableRequest\x1a\x1e.worker.IsTAPAvailableResponse\x12O\n" +
	"\x0eSaveAsTemplate\x12\x1d.worker.SaveAsTemplateRequest\x1a\x1e.worker.SaveAsTemplateResponse\x12L\n" +
...
var file_proto_worker_worker_proto_msgTypes = make([]protoimpl.MessageInfo, 37)
var file_proto_worker_worker_proto_goTypes = []any{
	...
	(*IsTAPAvailableRequest)(nil),    // 28: worker.IsTAPAvailableRequest
	(*IsTAPAvailableResponse)(nil),   // 29: worker.IsTAPAvailableResponse
	(*SaveAsTemplateRequest)(nil),    // 30: worker.SaveAsTemplateRequest
	(*SaveAsTemplateResponse)(nil),   // 31: worker.SaveAsTemplateResponse
	(*BuildTemplateRequest)(nil),     // 32: worker.BuildTemplateRequest
	(*BuildTemplateResponse)(nil),    // 33: worker.BuildTemplateResponse
	(*GetSandboxStatsRequest)(nil),   // 34: worker.GetSandboxStatsRequest
	(*GetSandboxStatsResponse)(nil),  // 35: worker.GetSandboxStatsResponse
	nil,                              // 36: worker.CreateSandboxRequest.EnvsEntry
	nil,                              // 37: worker.ExecCommandRequest.EnvsEntry
}
var file_proto_worker_worker_proto_depIdxs = []int32{
	36, // 0: worker.CreateSandboxRequest.envs:type_name -> worker.CreateSandboxRequest.EnvsEntry
	6,  // 1: worker.ListSandboxesResponse.sandboxes:type_name -> worker.GetSandboxResponse
	37, // 2: worker.ExecCommandRequest.envs:type_name -> worker.ExecCommandRequest.EnvsEntry
	...
	28, // 19: worker.SandboxWorker.IsTAPAvailable:input_type -> worker.IsTAPAvailableRequest
	30, // 20: worker.SandboxWorker.SaveAsTemplate:input_type -> worker.SaveAsTemplateRequest
	32, // 21: worker.SandboxWorker.BuildTemplate:input_type -> worker.BuildTemplateRequest
	34, // 22: worker.SandboxWorker.GetSandboxStats:input_type -> worker.GetSandboxStatsRequest
	2,  // 23: worker.SandboxWorker.CreateSandbox:output_type -> worker.CreateSandboxResponse
	4,  // 24: worker.SandboxWorker.DestroySandbox:output_type -> worker.DestroySandboxResponse
	6,  // 25: worker.SandboxWorker.GetSandbox:output_type -> worker.GetSandboxResponse
	8,  // 26: worker.SandboxWorker.ListSandboxes:output_type -> worker.ListSandboxesResponse
	10, // 27: worker.SandboxWorker.ExecCommand:output_type -> worker.ExecCommandResponse
	11, // 28: worker.SandboxWorker.ExecCommandStream:output_type -> worker.ExecOutputChunk
	13, // 29: worker.SandboxWorker.ReadFile:output_type -> worker.ReadFileResponse
	15, // 30: worker.SandboxWorker.WriteFile:output_type -> worker.WriteFileResponse
	18, // 31: worker.SandboxWorker.ListDir:output_type -> worker.ListDirResponse
	20, // 32: worker.SandboxWorker.CreatePTY:output_type -> worker.CreatePTYResponse
	23, // 33: worker.SandboxWorker.PTYStream:output_type -> worker.PTYOutput
	25, // 34: worker.SandboxWorker.HibernateSandbox:output_type -> worker.HibernateSandboxResponse
	27, // 35: worker.SandboxWorker.WakeSandbox:output_type -> worker.WakeSandboxResponse
	29, // 36: worker.SandboxWorker.IsTAPAvailable:output_type -> worker.IsTAPAvailableResponse
	31, // 37: worker.SandboxWorker.SaveAsTemplate:output_type -> worker.SaveAsTemplateResponse
	33, // 38: worker.SandboxWorker.BuildTemplate:output_type -> worker.BuildTemplateResponse
	35, // 39: worker.SandboxWorker.GetSandboxStats:output_type -> worker.GetSandboxStatsResponse
