...
const file_proto_worker_worker_proto_rawDesc = "" +
	...
	"\x04data\x18\x02 \x01(\fR\x04data2\x8a\x06\n" +
	"\rSandboxWorker\x12L\n" +
	...
	"\tPTYStream\x12\x10.worker.PTYInput\x1a\x11.worker.PTYOutput(\x010\x01B1Z/github.com/opensandbox/opensandbox/proto/workerb\x06proto3"
...
var file_proto_worker_worker_proto_msgTypes = make([]protoimpl.MessageInfo, 25)
var file_proto_worker_worker_proto_goTypes = []any{
	...
	nil,                            // 24: worker.CreateSandboxRequest.EnvsEntry
	nil,                            // 25: worker.ExecCommandRequest.EnvsEntry
}
var file_proto_worker_worker_proto_depIdxs = []int32{
	24, // 0: worker.CreateSandboxRequest.envs:type_name -> worker.CreateSandboxRequest.EnvsEntry
	6,  // 1: worker.ListSandboxesResponse.sandboxes:type_name -> worker.GetSandboxResponse
	25, // 2: worker.ExecCommandRequest.envs:type_name -> worker.ExecCommandRequest.EnvsEntry
	...
	2,  // 17: worker.SandboxWorker.CreateSandbox:output_type -> worker.CreateSandboxResponse
	4,  // 18: worker.SandboxWorker.DestroySandbox:output_type -> worker.DestroySandboxResponse
	6,  // 19: worker.SandboxWorker.GetSandbox:output_type -> worker.GetSandboxResponse
	8,  // 20: worker.SandboxWorker.ListSandboxes:output_type -> worker.ListSandboxesResponse
	10, // 21: worker.SandboxWorker.ExecCommand:output_type -> worker.ExecCommandResponse
	11, // 22: worker.SandboxWorker.ExecCommandStream:output_type -> worker.ExecOutputChunk
	13, // 23: worker.SandboxWorker.ReadFile:output_type -> worker.ReadFileResponse
	15, // 24: worker.SandboxWorker.WriteFile:output_type -> worker.WriteFileResponse
	18, // 25: worker.SandboxWorker.ListDir:output_type -> worker.ListDirResponse
	20, // 26: worker.SandboxWorker.CreatePTY:output_type -> worker.CreatePTYResponse
	23, // 27: worker.SandboxWorker.PTYStream:output_type -> worker.PTYOutput
